...
DEFAULT_PROVEEDOR_USERS = {
    ...
    "contreras": {"password": _PROVEEDOR_PWD, "nombre": "Contreras Mauricio Sergio", "tipo_cuenta": "fumigacion", "proveedores": ["Contreras Mauricio Sergio"]},
    "manggini": {"password": _PROVEEDOR_PWD, "nombre": "Manggini Pablo y Ulises", "tipo_cuenta": "fumigacion", "proveedores": ["Manggini Pablo y Ulises"]},
    "imhoff": {"password": _PROVEEDOR_PWD, "nombre": "Imhoff Fernando Alberto", "tipo_cuenta": "fumigacion", "proveedores": ["Imhoff Fernando Alberto"]},
    "felix_millan": {"password": _PROVEEDOR_PWD, "nombre": "Felix Raul Millan", "tipo_cuenta": "fumigacion", "proveedores": ["Felix Raul Millan"]},
    "nazareno": {"password": _PROVEEDOR_PWD, "nombre": "Nazareno Marchilli", "tipo_cuenta": "fumigacion", "proveedores": ["Nazareno Marchilli"]},
    "comservar": {"password": _PROVEEDOR_PWD, "nombre": "Comservar SRL", "tipo_cuenta": "fumigacion", "proveedores": ["Comservar SRL"]},
    "rabincho": {"password": _PROVEEDOR_PWD, "nombre": "Rabincho SRL", "tipo_cuenta": "fumigacion", "proveedores": ["Rabincho SRL"]},
    "perez_bobadilla": {"password": _PROVEEDOR_PWD, "nombre": "Perez Bobadilla Nicolas", "tipo_cuenta": "fumigacion", "proveedores": ["Perez Bobadilla Nicolas"]},
    "marcelo_pedregal": {"password": _PROVEEDOR_PWD, "nombre": "Marcelo Domingo Pedregal", "tipo_cuenta": "fumigacion", "proveedores": ["Marcelo Domingo Pedregal"]},
    "ult": {"password": _PROVEEDOR_PWD, "nombre": "ULT SRL", "tipo_cuenta": "fumigacion", "proveedores": ["ULT SRL"]},
    "landini": {"password": _PROVEEDOR_PWD, "nombre": "LANIDINI - VENA SALVADOR", "tipo_cuenta": "fumigacion", "proveedores": ["LANIDINI - VENA SALVADOR"]},
    "castro_luna": {"password": _PROVEEDOR_PWD, "nombre": "Castro Luna Dario", "tipo_cuenta": "fumigacion", "proveedores": ["Castro Luna Dario"]},
    "chasqui": {"password": _PROVEEDOR_PWD, "nombre": "CHASQUI SRL", "tipo_cuenta": "fumigacion", "proveedores": ["CHASQUI SRL"]},
    "mak_consulter": {"password": _PROVEEDOR_PWD, "nombre": "Mak Consulter S.R.L", "tipo_cuenta": "fumigacion", "proveedores": ["Mak Consulter S.R.L"]},
...
PROVEEDORES = [
    ...
    {"nombre": "Escalmeca / Mauricio", "zona": "AMBA", "tipo": "Ascensores / escaleras mecanicas", "tel": "115308-9834", "fijo": True, "estado_operativo": "Abono mensual", "canal_comunicacion": "Mail", "sucursales": ["183","184","186"], "monto": "$688.000 + IVA/mes", "incluye": "Mantenimiento preventivo de 8 escaleras mecanicas en 3 sucursales, lubricacion, engrase, limpieza, desarme parcial", "no_incluye": "-"},
    ...
    {"nombre": "Nestor Raul Diaz", "zona": "Neuquen", "tipo": "General", "tel": "299-418-7955", "estado_operativo": "Contacto", "canal_comunicacion": "Telefono", "sucursales": ["133"]},
    {"nombre": "Federico Confort", "zona": "Parana", "tipo": "General + AA", "tel": "299-418-7955", "contacto": "Federico", "fijo": False, "estado_operativo": "Contacto", "canal_comunicacion": "Telefono / mail", "sucursales": ["178","210"]},
    {"nombre": "Javier", "zona": "Santa Fe", "tipo": "General", "tel": "342-478-0031", "estado_operativo": "Contacto", "canal_comunicacion": "Telefono", "sucursales": ["226"]},
    {"nombre": "Gerardo Goog", "zona": "AMBA", "tipo": "Fumigaciones", "tel": "115851-5565", "estado_operativo": "Fumigacion con portal", "requiere_portal": True, "canal_comunicacion": "Portal proveedores", "workflow": "fumigacion_remito", "sucursales": ["052","167","187"], "mostrar_sucursal": False},
    {"nombre": "Pablo Norsuply", "zona": "AMBA", "tipo": "Insumos", "tel": "115923-5320", "estado_operativo": "Contacto", "canal_comunicacion": "Telefono", "sucursales": ["AMBA general"]},
    ...
    {"nombre": "Diprogom", "zona": "AMBA", "tipo": "Matafuegos", "tel": "-", "fijo": False, "estado_operativo": "Matafuegos con portal", "requiere_portal": True, "canal_comunicacion": "Portal proveedores", "workflow": "matafuegos_remito_vencimiento", "sucursales": ["036","043","053","077","167","171","176","177","183","184","185","187","188","190","194","198","200","202","204","208","209","213","214","216","219","221","222","232"], "sucursales_conflicto": {"051": 13, "156": 23}, "sucursales_pendientes": {"MORZAT": 14}, "observacion": "Cartera Diprogom 2026-09-24: 28 sucursales y 433 equipos confirmados. Sucursales 051 y 156 excluidas por conflicto de proveedor. Parque Industrial Morzat pendiente sin número; no inferir Garín. Conserva la cuenta existente y no activa credenciales nuevas."},
    ...
    {"nombre": "Municipalidad de Moreno", "zona": "AMBA", "tipo": "Fumigaciones", "tel": "-", "fijo": False, "estado_operativo": "Fumigacion caja / sin portal", "canal_comunicacion": "Caja mensual", "workflow": "notificacion_mensual_remito", "sucursales": ["023","232"], "mostrar_sucursal": False},
    {"nombre": "Jorge Alejandro Gardel", "zona": "NOA", "tipo": "Fumigaciones", "tel": "-", "fijo": False, "estado_operativo": "Contacto", "canal_comunicacion": "Telefono", "sucursales": [], "mostrar_sucursal": False, "observacion": "Fumigador sin sucursales activas; se volvio caro"},
    {"nombre": "Imhoff Fernando Alberto", "zona": "Litoral", "tipo": "Fumigaciones", "tel": "-", "fijo": False, "estado_operativo": "Fumigacion con portal", "requiere_portal": True, "canal_comunicacion": "Portal proveedores", "workflow": "fumigacion_remito", "sucursales": ["114","226"], "mostrar_sucursal": False},
    {"nombre": "Felix Raul Millan", "zona": "Cuyo", "tipo": "Fumigaciones", "tel": "-", "fijo": False, "estado_operativo": "Fumigacion con portal", "requiere_portal": True, "canal_comunicacion": "Portal proveedores", "workflow": "fumigacion_remito", "sucursales": ["145"], "mostrar_sucursal": False},
    {"nombre": "Nazareno Marchilli", "zona": "AMBA", "tipo": "Fumigaciones", "tel": "-", "fijo": False, "estado_operativo": "Fumigacion con portal", "requiere_portal": True, "canal_comunicacion": "Portal proveedores", "workflow": "fumigacion_remito", "sucursales": ["116"], "mostrar_sucursal": False},
    {"nombre": "Comservar SRL", "zona": "Cuyo", "tipo": "Fumigaciones", "tel": "-", "fijo": False, "estado_operativo": "Fumigacion con portal", "requiere_portal": True, "canal_comunicacion": "Portal proveedores", "workflow": "fumigacion_remito", "sucursales": ["207"], "mostrar_sucursal": False},
    {"nombre": "Rabincho SRL", "zona": "NEA", "tipo": "Fumigaciones", "tel": "-", "fijo": False, "estado_operativo": "Fumigacion con portal", "requiere_portal": True, "canal_comunicacion": "Portal proveedores", "workflow": "fumigacion_remito", "sucursales": ["220"], "mostrar_sucursal": False},
    {"nombre": "Perez Bobadilla Nicolas", "zona": "NEA", "tipo": "Fumigaciones", "tel": "-", "fijo": False, "estado_operativo": "Fumigacion con portal", "requiere_portal": True, "canal_comunicacion": "Portal proveedores", "workflow": "fumigacion_remito", "sucursales": ["224"], "mostrar_sucursal": False},
    {"nombre": "Marcelo Domingo Pedregal", "zona": "NOA", "tipo": "Fumigaciones", "tel": "-", "fijo": False, "estado_operativo": "Fumigacion con portal", "requiere_portal": True, "canal_comunicacion": "Portal proveedores", "workflow": "fumigacion_remito", "sucursales": ["229"], "mostrar_sucursal": False},
    {"nombre": "ULT SRL", "zona": "NOA", "tipo": "Fumigaciones", "tel": "-", "fijo": False, "estado_operativo": "Fumigacion con portal", "requiere_portal": True, "canal_comunicacion": "Portal proveedores", "workflow": "fumigacion_remito", "sucursales": ["235"], "mostrar_sucursal": False},
    # --- Nuevos proveedores fumigacion (actualizado 05/05/2026 - Rita Robles) ---
    {"nombre": "LANIDINI - VENA SALVADOR", "zona": "Litoral", "tipo": "Fumigaciones", "tel": "-", "fijo": False, "estado_operativo": "Fumigacion con portal", "requiere_portal": True, "canal_comunicacion": "Portal proveedores", "workflow": "fumigacion_remito", "sucursales": ["127","166"], "mostrar_sucursal": False},
    {"nombre": "Castro Luna Dario", "zona": "Cuyo", "tipo": "Fumigaciones", "tel": "-", "fijo": False, "estado_operativo": "Fumigacion con portal", "requiere_portal": True, "canal_comunicacion": "Portal proveedores", "workflow": "fumigacion_remito", "sucursales": ["128","206"], "mostrar_sucursal": False},
    {"nombre": "CHASQUI SRL", "zona": "Patagonia", "tipo": "Fumigaciones", "tel": "-", "fijo": False, "estado_operativo": "Fumigacion con portal", "requiere_portal": True, "canal_comunicacion": "Portal proveedores", "workflow": "fumigacion_remito", "sucursales": ["133"], "mostrar_sucursal": False},
    {"nombre": "Mak Consulter S.R.L", "zona": "Cuyo", "tipo": "Fumigaciones", "tel": "-", "fijo": False, "estado_operativo": "Fumigacion con portal", "requiere_portal": True, "canal_comunicacion": "Portal proveedores", "workflow": "fumigacion_remito", "sucursales": ["178"], "mostrar_sucursal": False},
    {"nombre": "FLR Control de Plagas (Isaurralde)", "zona": "Cuyo", "tipo": "Fumigaciones", "tel": "-", "fijo": False, "estado_operativo": "Fumigacion con portal", "requiere_portal": True, "canal_comunicacion": "Portal proveedores", "workflow": "fumigacion_remito", "sucursales": ["210"], "mostrar_sucursal": False},
    {"nombre": "EXTER - Caviglia y Tellarini S.A.", "zona": "PBA Sur", "tipo": "Fumigaciones", "tel": "-", "fijo": False, "estado_operativo": "Fumigacion con portal", "requiere_portal": True, "canal_comunicacion": "Portal proveedores", "workflow": "fumigacion_remito", "sucursales": ["217"], "mostrar_sucursal": False},
    {"nombre": "MIPSA SRL", "zona": "Patagonia", "tipo": "Fumigaciones", "tel": "-", "fijo": False, "estado_operativo": "Fumigacion con portal", "requiere_portal": True, "canal_comunicacion": "Portal proveedores", "workflow": "fumigacion_remito", "sucursales": ["134","231"], "mostrar_sucursal": False},
    {"nombre": "Fumigacion shopping IRSA / Cencosud", "zona": "Nacional", "tipo": "Fumigaciones", "tel": "-", "fijo": False, "estado_operativo": "Shopping / sin portal", "canal_comunicacion": "Sucursal / shopping", "sucursales": ["132 IRSA","160 Cencosud","236 IRSA"], "mostrar_sucursal": False},
    {"nombre": "Fumigacion anual a definir", "zona": "Nacional", "tipo": "Fumigaciones", "tel": "-", "fijo": False, "estado_operativo": "Revisar", "canal_comunicacion": "Mantenimiento", "sucursales": ["091","092","205"], "mostrar_sucursal": False, "observacion": "Se hacen una vez al año; Agustin queda en averiguar con mantenimiento"},
    {"nombre": "Sin servicio de fumigacion", "zona": "Nacional", "tipo": "Fumigaciones", "tel": "-", "fijo": False, "estado_operativo": "Sin servicio", "sucursales": ["239","240","241"], "mostrar_sucursal": False, "observacion": "Pendiente revisar si se fumigan mas adelante"},
]
...
QUOTE_STATE_SCOPES = {"abiertos", "cerrados", "todos"}
QUOTE_ATTACHMENT_SCOPES = {"todos", "con", "sin"}
QUOTE_FILTER_KEYS = (
    "proveedor_actual", "sucursal", "estado_scope", "categoria", "subcategoria",
    "prioridad", "fecha_desde", "fecha_hasta", "antiguedad_min", "antiguedad_max",
    "responsable", "adjuntos", "q",
)
QUOTE_PROVIDER_LEGACY_ALIASES = {
    "Julio Fuga (JRF)", "Julio Fuga", "JRF", "fuga",
    "Ismael Allende (JRF)", "Ismael Allende", "ismael",
}
...
QUOTE_FILTER_MAX_AGE_DAYS = 36500


def _quote_normalize(value):
...
def _quote_provider_aliases(selected):
    selected_norm = _quote_normalize(selected)
    aliases = {selected_norm} if selected_norm else set()
    groups = [{_quote_normalize(value) for value in QUOTE_PROVIDER_LEGACY_ALIASES}]
    for username, info in load_proveedor_users().items():
        values = {username, info.get("nombre", ""), *(info.get("proveedores") or [])}
        groups.append({_quote_normalize(value) for value in values if value})

    changed = True
    while changed:
        changed = False
        for group in groups:
            if aliases.intersection(group) and not group.issubset(aliases):
...
def _quote_ticket_provider_display(ticket, known_provider_aliases=None):
    ...
    for value in _quote_provider_values(ticket, known_provider_aliases=known_provider_aliases):
        ...
        if normalized and normalized not in seen:
            values.append(value)
            seen.add(normalized)
    return " / ".join(values) or "Sin proveedor"


def _quote_ticket_responsible_display(ticket):
    values = []
    seen = set()
    for field in QUOTE_RESPONSIBLE_FIELDS:
        value = str(ticket.get(field) or "").strip()
        normalized = _quote_normalize(value)
        if normalized and normalized not in seen:
            values.append(value)
            seen.add(normalized)
    return " / ".join(values) or "Sin responsable"
...
def _quote_filter_values(source, apply_initial_defaults=False):
    filters = {key: str(source.get(key, "") or "").strip() for key in QUOTE_FILTER_KEYS}
    if apply_initial_defaults:
        filters["proveedor_actual"] = QUOTE_DEFAULT_PROVIDER
        filters["estado_scope"] = "abiertos"
    filters["estado_scope"] = filters["estado_scope"] or "todos"
    filters["adjuntos"] = filters["adjuntos"] or "todos"

    if filters["estado_scope"] not in QUOTE_STATE_SCOPES:
        raise ValueError("El filtro de estado es inválido.")
    if filters["adjuntos"] not in QUOTE_ATTACHMENT_SCOPES:
        raise ValueError("El filtro de adjuntos es inválido.")
    for key, value in filters.items():
        limit = 200 if key == "q" else 120
        if len(value) > limit or any(ord(char) < 32 for char in value):
            raise ValueError("Uno de los filtros contiene un valor inválido.")
    for key in ("fecha_desde", "fecha_hasta"):
        if filters[key]:
            try:
                datetime.date.fromisoformat(filters[key])
            except ValueError as exc:
                raise ValueError("El rango de fechas es inválido.") from exc
    if filters["fecha_desde"] and filters["fecha_hasta"] and filters["fecha_desde"] > filters["fecha_hasta"]:
        raise ValueError("La fecha desde no puede ser posterior a la fecha hasta.")

    ages = {}
    for key in ("antiguedad_min", "antiguedad_max"):
        value = filters[key]
        if not value:
            ages[key] = None
            continue
        try:
            ...
            raise ValueError("La antigüedad debe expresarse en días enteros.") from exc
        if parsed < 0 or parsed > QUOTE_FILTER_MAX_AGE_DAYS:
            raise ValueError("La antigüedad indicada está fuera del rango permitido.")
        ages[key] = parsed
    if ages["antiguedad_min"] is not None and ages["antiguedad_max"] is not None and ages["antiguedad_min"] > ages["antiguedad_max"]:
...
def _quote_filter_tickets(tickets, filters, now=None):
    ...
    minimum_age = int(filters["antiguedad_min"]) if filters.get("antiguedad_min") else None
    maximum_age = int(filters["antiguedad_max"]) if filters.get("antiguedad_max") else None
    date_from = datetime.date.fromisoformat(filters["fecha_desde"]) if filters.get("fecha_desde") else None
    date_to = datetime.date.fromisoformat(filters["fecha_hasta"]) if filters.get("fecha_hasta") else None
    ...
    for ticket in tickets:
        ...
        if provider_filter == QUOTE_NO_PROVIDER and provider_values:
            continue
        if provider_aliases and not provider_norms.intersection(provider_aliases):
            continue

        state_scope = filters.get("estado_scope", "todos")
        if state_scope == "abiertos" and _ticket_estado_final(ticket):
            continue
        if state_scope == "cerrados" and not _ticket_estado_final(ticket):
            continue

        exact_filters = (
            ("sucursal", ticket.get("sucursal") or ticket.get("sucursal_num")),
            ("categoria", ticket.get("categoria")),
            ("subcategoria", ticket.get("subcategoria")),
        )
        if any(filters.get(key) and _quote_normalize(filters[key]) != _quote_normalize(value) for key, value in exact_filters):
            continue
        if filters.get("prioridad") and str(ticket.get("prioridad") or "").strip() != filters["prioridad"]:
            continue
        if filters.get("responsable"):
            responsible_values = {_quote_normalize(ticket.get(field)) for field in QUOTE_RESPONSIBLE_FIELDS if ticket.get(field)}
            if _quote_normalize(filters["responsable"]) not in responsible_values:
                continue

        created = _quote_ticket_created(ticket)
        if date_from and (not created or created.date() < date_from):
            continue
        if date_to and (not created or created.date() > date_to):
            continue
        age = _quote_ticket_age_days(ticket, now)
        if minimum_age is not None and (age == "" or age < minimum_age):
            continue
        if maximum_age is not None and (age == "" or age > maximum_age):
            continue

        attachment_count = len(_quote_attachment_paths(ticket))
        if filters.get("adjuntos") == "con" and attachment_count == 0:
            continue
        if filters.get("adjuntos") == "sin" and attachment_count > 0:
            continue

        if query:
            location = ticket.get("zona_afectada") or ticket.get("ubicacion") or ticket.get("sector_oficina") or ""
            haystack = " ".join(str(value or "") for value in (
                ticket.get("id"), ticket.get("descripcion"), location, ticket.get("observaciones"), _quote_ticket_notes(ticket),
            ))
            normalized_haystack = _quote_normalize(haystack)
            if any(term not in normalized_haystack for term in query.split()):
                continue
        eligible.append(ticket)
    return sorted(eligible, key=_quote_ticket_sort_key)


def _quote_filter_options(tickets):
    ...
    priorities = {str(number): label for number, label in PRIORIDADES.items()}
    for ticket in tickets:
        raw = str(ticket.get("prioridad") or "").strip()
        if raw and raw not in priorities:
            priorities[raw] = raw
    return {
        "proveedores": sorted(providers, key=_quote_normalize),
        "sucursales": unique(ticket.get("sucursal") or ticket.get("sucursal_num") for ticket in tickets),
        "categorias": unique(ticket.get("categoria") for ticket in tickets),
        "subcategorias": unique(ticket.get("subcategoria") for ticket in tickets),
        "prioridades": sorted(priorities.items(), key=lambda item: item[0]),
        "responsables": unique(
            ticket.get(field)
            for ticket in tickets
            for field in QUOTE_RESPONSIBLE_FIELDS
...
def _quote_filter_summary(filters):
    state_labels = {"abiertos": "Abiertos", "cerrados": "Cerrados/finalizados", "todos": "Todos"}
    attachment_labels = {"todos": "Todos", "con": "Con fotos/adjuntos", "sin": "Sin fotos/adjuntos"}
    labels = [f"Estado: {state_labels[filters.get('estado_scope', 'todos')]}" ]
    mappings = (
        ("sucursal", "Sucursal"), ("categoria", "Categoría"), ("subcategoria", "Subcategoría"),
        ("prioridad", "Prioridad"), ("fecha_desde", "Fecha de creación desde"), ("fecha_hasta", "Fecha de creación hasta"),
        ("antiguedad_min", "Antigüedad mínima"), ("antiguedad_max", "Antigüedad máxima"),
        ("responsable", "Responsable/asignado"), ("q", "Búsqueda"),
    )
    for key, label in mappings:
        if filters.get(key):
            suffix = " días" if key.startswith("antiguedad_") else ""
            labels.append(f"{label}: {filters[key]}{suffix}")
    if filters.get("adjuntos", "todos") != "todos":
        labels.append(f"Adjuntos: {attachment_labels[filters['adjuntos']]}")
    return "; ".join(labels)
...
def _quote_ticket_sort_key(ticket):
    ...
    return (_quote_normalize(sucursal), id_key)
...
def _build_quote_workbook(
    ...
    proveedor_destino,
    generated_at=None,
    proveedor_origen="Todos",
    filtros_aplicados="Sin filtros adicionales",
):
    ...
    origin_label = _quote_safe_text(proveedor_origen, 240) or "Todos"
    destination_label = _quote_safe_text(proveedor_destino, 120) or "A definir"
    filters_label = _quote_safe_text(filtros_aplicados, QUOTE_EXPORT_MAX_TEXT) or "Sin filtros adicionales"

    workbook = Workbook()
    summary = workbook.active
    summary.title = "Resumen"
    summary.append(["Cotización de reparaciones"])
    summary.append(["Proveedor origen", origin_label])
    summary.append(["Proveedor destino", destination_label])
    ...
    summary["A8"].font = summary["B8"].font = Font(bold=True, color="FFFFFF")
    summary["A8"].fill = summary["B8"].fill = PatternFill("solid", fgColor="334155")
    summary["B4"].number_format = "dd/mm/yyyy hh:mm"
    ...
    for branch, branch_tickets in groups.items():
        ...
        sheet.append(["Proveedor origen", origin_label])
        sheet.append(["Proveedor destino", destination_label])
        sheet.append(["Filtros aplicados", filters_label])
        ...
        for ticket in branch_tickets:
            ...
            if ticket_url:
                ticket_cell = sheet.cell(row_number, 14)
                ticket_cell.hyperlink = ticket_url
                ticket_cell.style = "Hyperlink"
            for index, attachment_path in enumerate(attachments):
                attachment_cell = sheet.cell(row_number, 15 + index)
                attachment_cell.hyperlink = _quote_attachment_url(attachment_path)
                attachment_cell.style = "Hyperlink"
            for cell in sheet[row_number]:
                cell.alignment = Alignment(vertical="top", wrap_text=True)

        widths = [22, 12, 28, 25, 22, 24, 48, 25, 14, 18, 20, 18, 52, 18] + [18] * max_attachments
        for index, width in enumerate(widths, start=1):
            sheet.column_dimensions[get_column_letter(index)].width = width
        sheet.auto_filter.ref = f"A7:{get_column_letter(len(headers))}{sheet.max_row}"
        ...
        sheet["B5"].number_format = "dd/mm/yyyy hh:mm"
...
def suc_seleccionar():
    return render_template(
        "error.html",
        mensaje="Acceso no autorizado. El ingreso de sucursales se identifica por la cuenta Microsoft 365, no por seleccion manual.",
    ), 403
...
def admin_cotizacion_reparaciones():
    ...
    apply_initial_defaults = request.method == "GET" and not request.query_string
    try:
        filters = _quote_filter_values(source, apply_initial_defaults=apply_initial_defaults)
    except ValueError as exc:
        return render_template("error.html", mensaje=str(exc)), 400
    ...
    if request.method == "POST":
        ...
        if any(ticket_id not in eligible_by_id for ticket_id in selected_ids):
            return render_template("error.html", mensaje="La selección contiene tickets que no pertenecen a los resultados filtrados."), 400

        selected = sorted((eligible_by_id[ticket_id] for ticket_id in selected_ids), key=_quote_ticket_sort_key)
        provider_filter = filters.get("proveedor_actual", "")
        if provider_filter == QUOTE_NO_PROVIDER:
            provider_origin = "Sin proveedor"
        else:
            provider_origin = provider_filter or "Todos"
        workbook = _build_quote_workbook(
            selected,
            proveedor_destino,
            generated_at=now,
            proveedor_origen=provider_origin,
            filtros_aplicados=_quote_filter_summary(filters),
        )
        output = io.BytesIO()
        workbook.save(output)
        workbook.close()
        output.seek(0)
        filename = f"cotizacion_reparaciones_{now:%Y%m%d_%H%M}.xlsx"
        return send_file(
            output,
            as_attachment=True,
    ...
    return render_template(
        ...
        filters=filters,
        filter_keys=QUOTE_FILTER_KEYS,
        options=_quote_filter_options(tickets),
        no_provider_value=QUOTE_NO_PROVIDER,
        ...
        if accion in etapa_labels:
            ...
            if accion == "relevado" and session.get("prov_tipo_cuenta") in ("fumigacion", "matafuegos"):
                if session.get("prov_tipo_cuenta") == "matafuegos":
                    mensaje_remito = (
                        f"{prov_nombre} informó que relevó la sucursal. "
                        "Por favor adjunten el remito y actualicen la fecha de vencimiento de los matafuegos."
                    )
                else:
                    mensaje_remito = (
